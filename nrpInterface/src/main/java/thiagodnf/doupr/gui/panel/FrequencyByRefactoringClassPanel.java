...
import thiagodnf.doupr.gui.model.table.FrequencyByRefactoringClassTableModel;
...
public class FrequencyByRefactoringClassPanel extends AbstractPanel {
    ...
    public FrequencyByRefactoringClassPanel(List<Solution> paretoFront) {
    ...
    public void addComponents() {
        ...
        this.table = new JTable(new FrequencyByRefactoringClassTableModel(paretoFront));
