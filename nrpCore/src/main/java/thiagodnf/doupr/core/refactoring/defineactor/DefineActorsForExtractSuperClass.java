...
public class DefineActorsForExtractSuperClass extends DefineActors {

    protected static final Logger LOGGER = Logger.getLogger(DefineActorsForExtractSuperClass.class);
    ...
    public Candidate execute(ProjectObject project) {
        ...
        while (!sourceClass.isConcrete() || sourceClass.hasSuperClass() || sourceClass.getMethods().size() < 2) {
