...
public class DefineActorsForIncreaseOrDecreaseFieldSecurity extends DefineActors {

    protected static final Logger LOGGER = Logger.getLogger(DefineActorsForIncreaseOrDecreaseFieldSecurity.class);
