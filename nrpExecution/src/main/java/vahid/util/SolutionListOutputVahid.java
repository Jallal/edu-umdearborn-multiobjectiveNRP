                ...
                for (int i = 0; i < solutionList.size(); ++i) {
                    for (int j = 0; j < numberOfObjectives; ++j) {
                        if ((Boolean) minimizeObjective.get(j)) {
                            bufferedWriter.write(((Solution) solutionList.get(i)).getObjective(j) + "");
                        } else {
                            bufferedWriter.write(-1.0D * ((Solution) solutionList.get(i)).getObjective(j) + "");
                        }
